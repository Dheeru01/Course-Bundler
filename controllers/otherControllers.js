...
export const contact = catchAsyncError(async(req,res,next)=>{
    ...
    if(!name || !email || !message) return next(new ErrorHandler("Please fill all the fields", 400))
...
export const courseRequest = catchAsyncError(async(req,res,next)=>{
    ...
    if(!name || !email || !course) return next(new ErrorHandler("Please fill all the fields", 400))
